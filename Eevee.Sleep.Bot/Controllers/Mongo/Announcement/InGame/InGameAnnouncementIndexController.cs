...
public static class InGameAnnouncementIndexController {
    ...
    public static async Task<IEnumerable<InGameAnnouncementIndexModel>> BulkUpsert(
        InGameAnnouncementIndexModel[] models
    ) {
        ...
        await MongoConst.InGameAnnouncementIndexCollection.BulkWriteAsync(announcements);
